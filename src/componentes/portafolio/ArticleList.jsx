...
export default class ArticleList extends React.Component {
        ...
        {this.props.articles.map(article => (
            ...
            <div className="article-container" key={article.id}>
                <div className="img-container">
                    <img src={article.image[0]} alt={article.title} onClick={()=>(this.openmodalarticule(article.id))} />
                </div>
  ...
  >
    ...
    nextIcon={<IoIosArrowForward color="black" size={50}></IoIosArrowForward>} 
    nextLabel={""} 
    prevLabel={""} 
    prevIcon={<IoIosArrowBack color="black" size={50}></IoIosArrowBack>} activeIndex={this.state.index} onSelect={this.handleSelect}>
    ...
    <Modal.Footer>
      ...
      <a href={this.state.link}><AiOutlineLink size={30}></AiOutlineLink></a>
     
   
      <a href={this.state.github}><AiFillGithub size={30}></AiFillGithub></a>
      </div>
      </div>
    </Modal.Footer>
  </Modal>
